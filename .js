...
function alertGuide() {
  alert("Hello, thankyou for visiting my clone of Google Chrome! Let me first tell you that in this clone, what is working and what's not. Here's the list:\n\nWhat's working:\nhomeIcon, leftArrowIcon, rightArrowIcon, reloadIcon, starIcon, newTabFunction, numOfTabs(click), kebabMenuIcon, adding new tab, closing a tab, searching site with iframe url, counting bookmark pages, counting numOfTabs. Inside kebabMenuIcon - newTabFunction, bookmarkPage\n\nWhat's not working:\ndownloadIcon, micIcon, and all others left inside the kebabMenuIcon.\n\nNow let's go and enjoy the chrome clone!");
}
$(function() {
